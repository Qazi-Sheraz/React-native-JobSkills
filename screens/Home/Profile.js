...
function Profile({navigation}) {
  ...
  return store.myProfileApiLoader ? (
    // <ActivityIndicator />
    <CLProfile />
  ) : (
    <JScreen
                  ...
                  <JProfileInfo
                    ...
                    text={
                      store.myProfile?.user[0]?.general_information
                        ...
                        ? 'N/A'
                        : store.myProfile?.user[0]?.general_information
                            ?.father_name?.length > 50
                        ? store.myProfile?.user[0]?.general_information?.father_name?.substring(
                            0,
                            50,
                          ) + ' . . . .'
                        : store.myProfile?.user[0]?.general_information
          ...
          <JProfileSections
            ...
            IconPress2={() => {
              navigation.navigate('CEditProfile', {
                selected: 2,
                career_level:
                  store.myProfile?.user[0]?.experience_information?.career_level
                    .id !== null && store.lang.id == 0
