...
const EducationInfo = () => {
    ...
    const _addEducation = values => {
        ...
        fetch(
            !params ? `${url.baseUrl}/candidate-education-create` : `${url.baseUrl}/candidate-education-update/${params?.educationId}`,
            requestOptions,
        )
            .then(response => response.json())
            .then(result => {
                ...
                : 
                    ...
                    <Formik
                        initialValues={{
                            ...
                            level: {
                                id:
                                    params?.degree_level_id !== null
                                        ? params?.degree_level_id
                                        : '',
                                name:
                                    params?.degree_level !== null
                                        ? params?.degree_level
                                        : '',
                            },
                            county: {
                            ...
                            institude:
                                params?.institute !== null
                                    ...
                                    : '',
                            result:
                                params?.result !== null ? params?.result : '',
                            year: {
                                name: params?.year !== null ? params?.year : '',
                            },
                        }}
                        onSubmit={values => {
