            ...
            {loader ? <ActivityIndicator />
                ...
                >
                    {({
                        ...
                        <View
                            style={{ justifyContent: 'space-between', flex: 1, marginHorizontal: RFPercentage(2), marginBottom: RFPercentage(5) }}>
                            {reschedule == true ?
                                <View >
                                    <JText style={styles.headers}>
                                        {store.lang.interview_date} :
                                    </JText>
                                    <JText style={styles.date}>{!details ? '--/--/--' : moment(details?.start_time).format('DD/MM/YYYY')}</JText>
                                ...
                                : <View >
                                    ...
                                    <JText style={styles.date}>
                                        {!details ? '--/--/--' : moment(details?.start_time).format('DD/MM/YYYY')}
                                    </JText>
