          ...
          validationSchema={yup.object().shape({
            ...
            salaryTo: yup
              ...
              .test(
                ...
                store.lang.Salary_To_must_be_greater_than_salary_From,
                function (value) {
            ...
            <>
              <KeyboardAwareScrollView
                ...
                <JSelectInput
                  ...
                  data={
                    store.lang.id == 0
                      ? store.jobCreate?.english_data?.preference
                      : store.jobCreate?.arabic_data?.preference
                  }
                ...
                <JSelectInput
                  ...
                  data={
                    store.lang.id == 0
                      ? store.jobCreate?.english_data?.currencies
                      : store.jobCreate?.arabic_data?.currencies
                  }
                ...
                <JSelectInput
                  ...
                  data={
                    store.lang.id == 0
                      ? store.jobCreate?.english_data?.salaryPeriods
                      : store.jobCreate?.arabic_data?.salaryPeriods
                  }
