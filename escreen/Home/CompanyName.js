        ...
        <SafeAreaView style={styles.centeredView}>
            ...
            <Formik
                ...
                onSubmit={values => {
                    ...
                    fetch("https://dev.jobskills.digital/api/update/employee/company", requestOptions)
                ...
                {({
                    ...
                    <View
                        style={styles.modalView1}>
                            <JText style={{color:colors.info[0],fontWeight:'bold',fontSize:RFPercentage(2.3)}}>{store.employeHome?.error}</JText>
                        <JInput
